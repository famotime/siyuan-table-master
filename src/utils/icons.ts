...
export const icons = {
  ...
  distributeRows: makeSvg('<line x1="3" x2="21" y1="4" y2="4"/><line x1="3" x2="21" y1="20" y2="20"/><rect width="14" height="4" x="5" y="7" rx="1"/><rect width="14" height="4" x="5" y="13" rx="1"/>'),
  distributeCols: makeSvg('<line x1="4" x2="4" y1="3" y2="21"/><line x1="20" x2="20" y1="3" y2="21"/><rect width="4" height="14" x="7" y="5" rx="1"/><rect width="4" height="14" x="13" y="5" rx="1"/>'),
  sortAsc: makeSvg('<path d="m3 8 4-4 4 4"/><path d="M7 4v16"/><path d="M15 4h5"/><path d="M15 10h7"/><path d="M15 16h9"/>'),
  ...
  autoFit: makeSvg('<polyline points="4 14 10 14 10 20"/><polyline points="20 10 14 10 14 4"/><line x1="14" x2="21" y1="10" y2="3"/><line x1="3" x2="10" y1="21" y2="14"/>'),
  tableHeader: makeSvg('<rect width="18" height="18" x="3" y="3" rx="2"/><path d="M3 8h18" stroke-width="3"/>'),
  tableTotal: makeSvg('<rect width="18" height="18" x="3" y="3" rx="2"/><path d="M3 16h18" stroke-width="3"/>'),
  help: makeSvg('<circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><line x1="12" x2="12.01" y1="17" y2="17"/>'),
  drag: makeSvg('<circle cx="9" cy="12" r="1"/><circle cx="9" cy="5" r="1"/><circle cx="9" cy="19" r="1"/><circle cx="15" cy="12" r="1"/><circle cx="15" cy="5" r="1"/><circle cx="15" cy="19" r="1"/>'),
};
