...
export const icons = {
  ...
  caption: makeSvg('<path d="M6 4v16"/><path d="M18 4v16"/><path d="M6 12h12"/>'),
  ...
  merge: makeSvg('<rect width="18" height="18" x="3" y="3" rx="2"/><path d="M8 12h8"/><path d="m11 9-3 3 3 3"/><path d="m13 9 3 3-3 3"/>'),
