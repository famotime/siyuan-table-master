...
export const icons = {
  ...
  selectAll: makeSvg('<rect x="3" y="3" width="18" height="18" rx="2" stroke-dasharray="3 3"/><rect x="7" y="7" width="10" height="10" rx="1"/>'),
  caption: makeSvg('<path d="M4 6h16"/><path d="M4 12h16"/><path d="M4 18h10"/>'),
  addRow: makeSvg('<rect width="18" height="18" x="3" y="3" rx="2"/><path d="M3 12h18"/><path d="M12 7v10"/>'),
  addCol: makeSvg('<rect width="18" height="18" x="3" y="3" rx="2"/><path d="M12 3v18"/><path d="M7 12h10"/>'),
