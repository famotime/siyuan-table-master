...
export const SVG_ICONS: Record<string, string> = {
  ...
  "html-open-dialog-editor": `<svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h7" style="fill:none!important"/><path d="M3 9h16M9 3v18" style="fill:none!important"/><path d="M18.4 9.6a2 2 0 1 1 2.8 2.8L15 18l-3 1 1-3 5.4-5.4z" style="fill:none!important"/></svg>`
};
